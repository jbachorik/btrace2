...
import com.sun.btrace.support.InstrumentorTestBase;
...
public class InstrumentorTest extends InstrumentorTestBase {
    ...
    public void matchDerivedClass() throws Exception {
        ...
        checkTransformation("ALOAD 0\nALOAD 1\nALOAD 2\n" +
                            "INVOKESTATIC resources/DerivedClass.$btrace$traces$onmethod$MatchDerived$args (Ljava/lang/Object;Ljava/lang/String;Ljava/util/Map;)V");
    }
