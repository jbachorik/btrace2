 ...
 * every 4 seconds.
 */
@BTrace public class Histogram1 {
   private static Aggregation histogram = Aggregations.newAggregation(AggregationFunction.QUANTIZE);
    ...
    public static void onnewObject(@Self Object obj) {
        ...
        AggregationKey key = Aggregations.newAggregationKey(cn);
        Aggregations.addToAggregation(histogram, key, Threads.threadId(Threads.currentThread()));
    }
