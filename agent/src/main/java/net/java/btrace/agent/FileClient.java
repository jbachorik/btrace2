...
class FileClient extends Client {
    ...
    FileClient(Instrumentation inst, byte[] code, PrintWriter traceWriter, ExtensionsRepository eLocator) throws IOException {
        super(inst, eLocator);
...
//        }
    ...
    FileClient(Instrumentation inst, File scriptFile, PrintWriter traceWriter, ExtensionsRepository eLocator) throws IOException {
