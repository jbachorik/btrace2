...
/**
 * Manages the encountered exceptions on BTrace friendly way
 * 
...
public interface Exceptions {
     ...
     */
    abstract public RuntimeException translate(Exception exp);
    /**
     * Marshals the exception through the BTrace communication channel.
     * The exception details will be available to clients
     * @param e The exception to marshal
     */
    abstract public void throwException(Exception e);
}
