...
/**
 * Provides access to the arguments the application was started with
...
public interface Arguments {
     ...
     */
    abstract public String $(int n);
    
    /**
     * BTrace runtime arguments accessor
     * @return The rutime arguments array
     */
    abstract public String[] $$();
    
    /**
     * 
     * @return The deployed trace class name
     */
